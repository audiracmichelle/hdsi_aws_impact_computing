...
2. [**Harvard AWS account**](https://www.huit.harvard.edu/cloud-consulting-and-enablement) Harvard IT (HUIT) provides access to the "Harvard AWS Console," for which you must have a Harvard affiliation and use Harvard's Cloud Account Provisioning portal.
